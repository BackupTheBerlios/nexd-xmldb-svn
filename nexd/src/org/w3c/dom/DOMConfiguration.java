 ...
 * are recommended to follow the section 5.16 Identifiers of [Unicode] with the 
 * addition of the character '-' (HYPHEN-MINUS) but it is not 
 ...
 * specified in [<a href='http://www.w3.org/TR/2001/REC-xml-c14n-20010315'
 * >Canonical XML</a>], 
 ...
 * <dt>
 * <code>true</code></dt>
 * <dd>[<em>required</em>] (<em>default</em>)Keep <code>Comment</code> nodes 
 * in the document.</dd>
 * <dt><code>false</code></dt>
 ...
 * nodes are normalized, as defined in <code>Node.normalize</code>. Only <a 
 ...
 * <dd>[<em>required</em>] Contains a <code>DOMErrorHandler</code> object. If 
 * an error is 
 ...
 * attributes, specified or defaulted from 
 * the schema, in the document. See also the sections "Declaring Namespaces" 
 * in [<a href='http://www.w3.org/TR/1999/REC-xml-names-19990114/'>XML 
 * Namespaces</a>]
 ...
 * </a>], applications must use the value 
 ...
 * <dt>
 * <code>true</code></dt>
 * <dd>[<em>required</em>] (<em>default</em>)Split CDATA sections containing 
 * the CDATA section termination marker 
 ...
 * processing, including the internal subset 
 ...
 * performed if the document has a schema, 
 ...
 * formed according to the XML version in 
