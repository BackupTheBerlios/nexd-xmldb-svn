...
/*
 * $Log: NonImplementationParser.java,v $
 ...
 */
public abstract class NonImplementationParser extends AbstractVCLParser {
     ...
     * @see de.xplib.nexd.api.vcl.VCLParserI#parse(org.xml.sax.InputSource)
     */
    public VCLSchema parse(InputSource isIn) throws IOException, SAXException,
