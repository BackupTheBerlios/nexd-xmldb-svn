...
import de.xplib.nexd.engine.xml.dom.CommentImpl;
import de.xplib.nexd.engine.xml.dom.DOMImplementationImpl;
import de.xplib.nexd.engine.xml.dom.DocumentImpl;
import de.xplib.nexd.engine.xml.dom.ElementNSImpl;
import de.xplib.nexd.engine.xml.dom.ProcessingInstructionImpl;
import de.xplib.nexd.engine.xml.jaxp.DocumentBuilderFactoryImpl;
import de.xplib.nexd.engine.xml.jaxp.DocumentBuilderImpl;
...
/*        
    ...
    public void testStructure() throws Exception {
        ...
        File f = new File("data/test/namespace3.xml");
        ...
        assertEquals(
                doc.getDocumentElement()
                    .getFirstChild().getNextSibling()
                    .getFirstChild().getNextSibling()
                    .getAttributes().item(0).getNodeName(), "class");
    ...
    public void testDTD() throws Exception {
        ...
        File f = new File("data/test/package.xml");
        Document doc = db.parse(f);
    }
