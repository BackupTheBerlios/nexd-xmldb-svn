...
public interface SessionI {
    ...
    /**
     * @label returns reference
     */

    /*#de.xplib.nexd.comm.NEXDEngineI Dependency_Link*/

    /**
     * @return An instance of the underlying <code>NEXDEngineI</code>.
     ...
     */
    NEXDEngineI getEngine() throws ConnectionException, MaxConnectionException,
