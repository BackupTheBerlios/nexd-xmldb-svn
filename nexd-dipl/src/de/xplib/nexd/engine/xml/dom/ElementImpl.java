 ...
 *
 * Revision 1.7  2005/03/01 10:25:11  nexd
...
public class ElementImpl extends AbstractParentNode implements Element {
     ...
     */
    protected NamedNodeMapImpl attributes = new NamedNodeMapImpl(this);
    ...
    public Node cloneNode(final boolean deep) {
        Element elem = this.ownerDocument.createElement(this.getTagName());
        for (int i = 0, l = this.attributes.getLength(); i < l; i++) {
            Node node = this.attributes.item(i);
            elem.setAttribute(node.getNodeName(), node.getNodeValue());
        }
        if (deep && this.hasChildNodes()) {
            NodeList nodes = this.getChildNodes();
            for (int i = 0, l = nodes.getLength(); i < l; i++) {
                elem.appendChild(nodes.item(i).cloneNode(deep));
            }
        }
        return elem;
    }
    ...
    public void setAttribute(final String name, final String value)
        ...
        AttrImpl attr = (AttrImpl) this.getOwnerDocument()
    ...
    public void removeAttribute(final String name) throws DOMException {
        try {
            ...
            if (this.internalId != null) {
                this.ownerDocument.cache.delete(attr);
            }
    ...
    public Attr setAttributeNode(final Attr newAttr) throws DOMException {
        ...
        if (!this.ownerDocument.isLoading() && this.internalId != null) {
            this.ownerDocument.cache.insert((AbstractNode) newAttr);
        }
    ...
    public Attr removeAttributeNode(final Attr oldAttr) throws DOMException {
        ...
        this.attributes.removeNamedItem(oldAttr.getNodeName());
        ((AttrImpl) oldAttr).setOwnerElement(null);

        if (this.internalId != null) {
            this.ownerDocument.cache.delete((AbstractNode) oldAttr);
        }
    ...
    public NodeList getElementsByTagName(final String name) {
        ...
        Iterator iter = ((NodeListImpl) this.getChildNodes()).getList()
                .iterator();
        while (iter.hasNext()) {
            ...
            ElementImpl elem = (ElementImpl) obj;
            if (elem.getTagName().equals(name) || name.equals("*")) {
                list.add(elem);
            }
            list.addAll(((NodeListImpl) elem.getElementsByTagName(name))
                    .getList());
        }
        return nodeList;
    }
    ...
    public String getAttributeNS(final String namespaceURI,
        ...
        Node node = this.attributes.getNamedItemNS(namespaceURI, localName);
        return (node == null ? "" : node.getNodeValue());
    }
    ...
    public void setAttributeNS(final String namespaceURI,
        ...
        Attr attr = this.getOwnerDocument().createAttributeNS(namespaceURI,
                qualifiedName);
        attr.setValue(value);
    ...
    public void removeAttributeNS(final String namespaceURI,
        ...
        try {
            AttrImpl attr = (AttrImpl) this.attributes.removeNamedItemNS(
        ...
        while (iter.hasNext()) {
            ...
            if (obj instanceof ElementNSImpl) {
                if (!elem.getNamespaceURI().equals(namespaceURI)
                    ...
                    list.addAll(((NodeListImpl) elem.getElementsByTagNameNS(
                            namespaceURI, localName)).getList());
                    continue;
                }
    ...
    public void setIdAttributeNode(final Attr idAttr, final boolean isId)
        ...
        this.setAttributeNode(idAttr);
        if (isId) {
            ((AttrImpl) idAttr).setId();
        }

        /*
         if (idAttr.getOwnerElement() != null) {
         throw new DOMException(DOMException.INUSE_ATTRIBUTE_ERR, "");
         }
         if (isId) {
         ((AttrImpl) idAttr).setId();
         ...
         ((AttrImpl) idAttr).setOwnerElement(this);
         
         if (!this.ownerDocument.isLoading() && this.internalId != null) {
         this.ownerDocument.cache.insert((AbstractNode) idAttr);
         }*/
    }
    ...
    public void setIdAttributeNS(final String namespaceURI,
            final String localName, final boolean isId) throws DOMException {
