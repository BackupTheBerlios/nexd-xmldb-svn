...
public class TextImpl extends AbstractCharacterData implements Text {
    ...
    public Text splitText(final int offset) throws DOMException {
        ...
        String value2 = value.substring(offset);
        
        this.setNodeValue(value1);
        
        Text text = this.ownerDocument.createTextNode(value2);
        if (this.parentNode != null) {
            this.parentNode.insertBefore(text, this.getNextSibling());
        }
        return text;
    }
    ...
    public boolean getIsWhitespaceInElementContent() {
        return this.getNodeValue().indexOf(" ") != -1;
    }
    ...
    public String getWholeText() {
        ...
        while (tmpNode instanceof TextImpl) {
            currentNode = tmpNode;
            tmpNode     = currentNode.getPreviousSibling();
        }
        
        String data = "";
        while (currentNode instanceof TextImpl) {
            data       += currentNode.getNodeValue();
    ...
    public boolean isElementContentWhitespace() {
        return this.getNodeValue().trim().equals("");
    }
}
