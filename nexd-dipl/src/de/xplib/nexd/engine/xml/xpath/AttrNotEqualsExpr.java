...
/**
 * An expression testing that an attribute is not equal to a given string. A
 * '@attrName != "value"' test.
 * 
 ...
 */
public class AttrNotEqualsExpr extends AbstractAttrCompareExpr {
     ...
     * @param attrValueIn --
     */
    AttrNotEqualsExpr(final String attrNameIn, final String attrValueIn) {
