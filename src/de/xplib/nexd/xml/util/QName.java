 ...
 */
package de.xplib.nexd.xml.util;
...
public class QName {
    ...
    public boolean isValidNamespace() {
        ...
        if (prefix.equals("xml") && namespaceURI != defaultNS) {
            return false;
        }
        if ((prefix.equals("xmlns") || qualifiedName.equals("xmlns"))
    ...
    public static boolean isQName(final String qName) {
        ...
        if (col1 == -1) {
            return isNCName(qName);
        }

        return isNCName(qName.substring(0, col1)) 
     ...
     */
    protected static boolean isNCNameChar(final char c) {
     ...
     */
    protected static boolean isLetter(final char c) {
     ...
     */
    protected static boolean isBaseChar(final char c) {
    	return (c >= 0x0041 && c <= 0x005A) || (c >= 0x0061 && c <= 0x007A) 
                ...
                || (c >= 0x03D0 && c <= 0x03D6) || c == 0x03DA || c == 0x03DC 
                || c == 0x03DE || c == 0x03E0  
                ...
                || c == 0x0B3D || (c >= 0x0B5C && c <= 0x0B5D) 
                || (c >= 0x0B5F && c <= 0x0B61) || (c >= 0x0B85 && c <= 0x0B8A) 
                || (c >= 0x0B8E && c <= 0x0B90) || (c >= 0x0B92 && c <= 0x0B95) 
                || (c >= 0x0B99 && c <= 0x0B9A) || c == 0x0B9C 
                ...
                || (c >= 0x0D05 && c <= 0x0D0C) || (c >= 0x0D0E && c <= 0x0D10) 
                || (c >= 0x0D12 && c <= 0x0D28) || (c >= 0x0D2A && c <= 0x0D39) 
                || (c >= 0x0D60 && c <= 0x0D61) || (c >= 0x0E01 && c <= 0x0E2E) 
                || c == 0x0E30 || (c >= 0x0E32 && c <= 0x0E33) 
                || (c >= 0x0E40 && c <= 0x0E45) || (c >= 0x0E81 && c <= 0x0E82) 
                || c == 0x0E84 || (c >= 0x0E87 && c <= 0x0E88) || c == 0x0E8A 
                ...
                || (c >= 0x1154 && c <= 0x1155) || c == 0x1159 
                || (c >= 0x115F && c <= 0x1161) || c == 0x1163 || c == 0x1165 
                || c == 0x1167 || c == 0x1169 || (c >= 0x116D && c <= 0x116E) 
                || (c >= 0x1172 && c <= 0x1173) || c == 0x1175 || c == 0x119E
                || c == 0x11A8 || c == 0x11AB || (c >= 0x11AE && c <= 0x11AF) 
                || (c >= 0x11B7 && c <= 0x11B8) || c == 0x11BA 
                || (c >= 0x11BC && c <= 0x11C2) || c == 0x11EB || c == 0x11F0
                || c == 0x11F9 || (c >= 0x1E00 && c <= 0x1E9B) 
                ...
                || (c >= 0x1FB6 && c <= 0x1FBC) || c == 0x1FBE 
                || (c >= 0x1FC2 && c <= 0x1FC4) || (c >= 0x1FC6 && c <= 0x1FCC) 
                || (c >= 0x1FD0 && c <= 0x1FD3) || (c >= 0x1FD6 && c <= 0x1FDB) 
                || (c >= 0x1FE0 && c <= 0x1FEC) || (c >= 0x1FF2 && c <= 0x1FF4) 
                || (c >= 0x1FF6 && c <= 0x1FFC) || c == 0x2126 
                || (c >= 0x212A && c <= 0x212B) || c == 0x212E 
                || (c >= 0x2180 && c <= 0x2182) || (c >= 0x3041 && c <= 0x3094) 
     ...
     */
    protected static boolean isIdeographic(final char c) {
     ...
     */
    protected static boolean isCombiningChar(final char c) {
        return (c >= 0x0300 && c <= 0x0345) || (c >= 0x0360 && c <= 0x0361) 
                ...
                || (c >= 0x0ABE && c <= 0x0AC5) || (c >= 0x0AC7 && c <= 0x0AC9) 
                || (c >= 0x0ACB && c <= 0x0ACD) || (c >= 0x0B01 && c <= 0x0B03) 
                ...
                || (c >= 0x0BCA && c <= 0x0BCD) || c == 0x0BD7 
                || (c >= 0x0C01 && c <= 0x0C03) || (c >= 0x0C3E && c <= 0x0C44) 
                || (c >= 0x0C46 && c <= 0x0C48) || (c >= 0x0C4A && c <= 0x0C4D) 
                || (c >= 0x0C55 && c <= 0x0C56) || (c >= 0x0C82 && c <= 0x0C83) 
                || (c >= 0x0CBE && c <= 0x0CC4) || (c >= 0x0CC6 && c <= 0x0CC8) 
                || (c >= 0x0CCA && c <= 0x0CCD) || (c >= 0x0CD5 && c <= 0x0CD6) 
                || (c >= 0x0D02 && c <= 0x0D03) || (c >= 0x0D3E && c <= 0x0D43) 
                || (c >= 0x0D46 && c <= 0x0D48) || (c >= 0x0D4A && c <= 0x0D4D) 
     ...
     */
    protected static boolean isExtender(final char c) {
