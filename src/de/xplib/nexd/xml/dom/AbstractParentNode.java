...
public abstract class AbstractParentNode extends AbstractNode {
     ...
     */
    private NodeListImpl childNodes = new NodeListImpl(this);
    ...
    public Node getFirstChild() {
        if (this.hasChildNodes()) {
            return (Node) this.childNodes.item(0);
        }
        return null;
    }
    ...
    public Node getLastChild() {
        if (this.hasChildNodes()) {
            return (Node) this.childNodes.item(this.childNodes.getLength() - 1);
        }
        return null;
    }
    ...
    public Node appendChild(final Node newChild) throws DOMException {
        ...
        if (where == ADD_TOP) {
            this.childNodes.getList().add(0, newChild);
        } else {
            this.childNodes.getList().add(newChild);
        }
